                ...
                <article class="single-post-content row m0 post">
                    ...
                    <ul class="pager">
                        <li>
                            <h4>上一篇</h4>
                            @if($previous_article)
                            <h2 class="post-title"><a href="{{route('article.show',['id'=>$previous_article->id])}}">{{mb_substr($previous_article->title,0,10)}}...</a></h2>
                            {{--<h5 class="taxonomy pull-left"><i>in</i> <a href="#">image</a>, <a href="#">entertainment</a></h5>--}}
                            @else
                                <h2 class="post-title"><a href="javascript:;">已经到头了</a></h2>
                            @endif
                        </li>
                        <li>
                            <h4>下一篇</h4>
                            @if($next_article)
                            <h2 class="post-title"><a href="{{route('article.show',['id'=>$next_article->id])}}">{{mb_substr($next_article->title,0,10)}}...</a></h2>
                            {{--<h5 class="taxonomy pull-left"><i>in</i> <a href="#">image</a>, <a href="#">entertainment</a></h5>--}}
                            @else
                                <h2 class="post-title"><a href="javascript:;">已经到尾了</a></h2>
                            @endif
                        </li>
                    </ul>
            ...
            <div class="col-md-4 sidebar">
                ...
                <aside class="row m0 widget-author widget">
                    <div class="widget-author-inner row">
                        ...
                        <a href="#"><h2 class="author-name">高兵兵</h2></a>
                        <h5 class="author-title">九一 · 白羊</h5>
                        <p>PHP 是世界上最好的语言...不接受任何反驳</p>
                        <a href="{{route('myself')}}" class="know-more">了解更多</a>
                    </div>
                ...
                <aside class="row m0 widget widget-twitter">
                    <div class="widget-twitter-inner">
                        <h5 class="widget-meta"><i class="qq"></i>QQ EMAIL <a href="http://twitter.com/chivalricblog">844540467@qq.com</a></h5>
                        <div class="row tweet-texts">
                            <p>here is my github<a href="https://github.com/SweetSunnyFlower">#SweetSunnyFlower</a></p>
                        </div>
